  ...
  return (
    ...
    >
      <header className="mb-10 text-center">
        <h1 className="text-4xl font-extrabold drop-shadow-sm">Explore Videos</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 gap-y-8">
          {videos.map((video) => (
            <div key={video._id} className={`${isDarkMode ? "bg-gray-900" : "bg-white"}`}>
              <div
              ...
              <div className="px-6 py-1">
                <h3 className={`text-lg font-bold truncate ${isDarkMode ? "text-gray-100" : "text-gray-800"}`}>
                  {video.title}
                </h3>
                <p className={`text-sm mt-2 line-clamp-2 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                  {video.description || "No description available"}
                </p>
                <div className="grid gap-y-0 text-sm mt-2" style={{ gridTemplateColumns: "42% 42%", columnGap: "2%" }}>
                  <p>
