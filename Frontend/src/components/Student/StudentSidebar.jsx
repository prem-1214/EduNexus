...
import {
  FaHome, FaBook, FaCalendar, FaVideo, FaComments, FaFileAlt,
  FaStickyNote, FaDownload, FaChalkboardTeacher, FaGraduationCap,
  FaCog, FaSignOutAlt
} from "react-icons/fa";
...
const Sidebar = () => {
  ...
  return (
    <div className={`h-screen bg-gray-100 p-2 flex flex-col justify-between transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'} fixed left-0 top-0`}>
      <div>
        <img
