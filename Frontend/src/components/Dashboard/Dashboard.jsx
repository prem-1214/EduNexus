...
import { FaSearch, FaHome, FaBook, FaCalendar, FaVideo, FaComments, FaFileAlt, FaStickyNote, FaDownload, FaChalkboardTeacher, FaGraduationCap, FaCog } from "react-icons/fa";
    ...
    return (
      <div className="flex h-screen w-full overflow-hidden">
        <div className="flex-1 p-6 pt-20 md:pl-64 overflow-y-auto overflow-x-hidden bg-gray-50">
          ...
          {/* Header */}
          <h1 className="text-2xl font-bold mt-6">Hello Dhru 👋</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="bg-white p-4 shadow rounded">
              ...
              <ul className="text-sm text-gray-600">
                <li className="flex justify-between"><span>Auto-layout.pdf</span><span>8.5 MB</span></li>
                <li className="flex justify-between"><span>Design_Tips.png</span><span>2.5 MB</span></li>
              </ul>
            ...
            <div className="bg-white p-4 shadow rounded">
              ...
              <button className="bg-green-500 text-white px-4 py-1 mt-2 rounded">Join</button>
            </div>
